...
export const en = {
  ...
  veScript: 'My name is {name}. I work for Marico. I visit shops every day.',
  veScript2: 'Today I will visit many shops. I talk to shopkeepers about our products and our schemes.',
  veScript3: 'Now say this in your own words — do not read. Name three shops you visit, and what you usually tell them.',
  vePassageOf: 'Passage {n} of {total}',
  veReadAloud: 'Read this aloud',
  veSpeakFreely: 'Speak in your own words',
  veStart: 'Record This Passage',
  veReRecord: 'Record Again',
  vePrev: '‹ Previous',
  veNext: 'Next ›',
  veRecording: 'Speak now — keep talking',
  veSecondsLeft: '{s} seconds left',
  veDoneMark: '✓ Recorded',
  veProgress: '{n} of {total} recorded',
  veSave: 'Save My Voice',
