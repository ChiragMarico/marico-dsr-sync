...
export const hi = {
  ...
  veScript: 'मेरा नाम {name} है। मैं हर दिन Marico के लिए दुकानों पर जाता हूँ। आज मैं दुकानदारों से अपनी बातचीत रिकॉर्ड करूँगा।',
  veStart: 'रिकॉर्ड शुरू करें',
  veRecording: 'अब बोलें — पढ़ते रहें',
...
export const mr = {
  ...
  veScript: 'माझे नाव {name} आहे. मी दररोज Marico साठी दुकानांना भेट देतो. आज मी दुकानदारांशी माझे संभाषण रेकॉर्ड करणार आहे.',
  veStart: 'रेकॉर्ड सुरू करा',
  veRecording: 'आता बोला — वाचत राहा',
...
export const te = {
  ...
  veScript: 'నా పేరు {name}. నేను ప్రతిరోజూ Marico కోసం దుకాణాలకు వెళ్తాను. ఈరోజు నేను దుకాణదారులతో నా సంభాషణలు రికార్డ్ చేస్తాను.',
  veStart: 'రికార్డ్ మొదలుపెట్టండి',
  veRecording: 'ఇప్పుడు మాట్లాడండి — చదువుతూ ఉండండి',
