...
export const hi = {
  ...
  veScript: 'मेरा नाम {name} है। मैं Marico में काम करता हूँ। मैं हर दिन दुकानों पर जाता हूँ।',
  veScript2: 'आज मैं कई दुकानों पर जाऊँगा। मैं दुकानदारों से अपने प्रोडक्ट और स्कीम की बात करता हूँ।',
  veScript3: 'अब अपने शब्दों में बोलें — पढ़ें नहीं। तीन दुकानों के नाम बताएँ जहाँ आप जाते हैं, और आप उनसे क्या कहते हैं।',
  vePassageOf: '{total} में से {n}',
  veReadAloud: 'यह ज़ोर से पढ़ें',
  veSpeakFreely: 'अपने शब्दों में बोलें',
  veStart: 'यह हिस्सा रिकॉर्ड करें',
  veReRecord: 'फिर रिकॉर्ड करें',
  vePrev: '‹ पिछला',
  veNext: 'अगला ›',
  veRecording: 'अब बोलें — बोलते रहें',
  veSecondsLeft: '{s} सेकंड बाकी',
  veDoneMark: '✓ रिकॉर्ड हुआ',
  veProgress: '{total} में से {n} रिकॉर्ड हुए',
  veSave: 'मेरी आवाज़ सेव करें',
  veUploading: 'अपलोड हो रहा है…',
...
export const mr = {
  ...
  veScript: 'माझे नाव {name} आहे. मी Marico मध्ये काम करतो. मी दररोज दुकानांना भेट देतो.',
  veScript2: 'आज मी अनेक दुकानांना भेट देईन. मी दुकानदारांशी आमच्या प्रॉडक्ट आणि स्कीमबद्दल बोलतो.',
  veScript3: 'आता तुमच्या शब्दांत बोला — वाचू नका. तुम्ही जाता त्या तीन दुकानांची नावे सांगा आणि तुम्ही त्यांना काय सांगता ते सांगा.',
  vePassageOf: '{total} पैकी {n}',
  veReadAloud: 'हे मोठ्याने वाचा',
  veSpeakFreely: 'तुमच्या शब्दांत बोला',
  veStart: 'हा भाग रेकॉर्ड करा',
  veReRecord: 'पुन्हा रेकॉर्ड करा',
  vePrev: '‹ मागील',
  veNext: 'पुढील ›',
  veRecording: 'आता बोला — बोलत राहा',
  veSecondsLeft: '{s} सेकंद बाकी',
  veDoneMark: '✓ रेकॉर्ड झाले',
  veProgress: '{total} पैकी {n} रेकॉर्ड झाले',
  veSave: 'माझा आवाज सेव्ह करा',
  veUploading: 'अपलोड होत आहे…',
...
export const te = {
  ...
  veScript: 'నా పేరు {name}. నేను Marico లో పని చేస్తాను. నేను ప్రతిరోజూ దుకాణాలకు వెళ్తాను.',
  veScript2: 'ఈరోజు నేను చాలా దుకాణాలకు వెళ్తాను. నేను దుకాణదారులతో మా ఉత్పత్తులు, స్కీముల గురించి మాట్లాడతాను.',
  veScript3: 'ఇప్పుడు మీ సొంత మాటల్లో చెప్పండి — చదవవద్దు. మీరు వెళ్ళే మూడు దుకాణాల పేర్లు, వాళ్ళతో మీరు సాధారణంగా ఏం చెబుతారో చెప్పండి.',
  vePassageOf: '{total} లో {n}',
  veReadAloud: 'దీన్ని బిగ్గరగా చదవండి',
  veSpeakFreely: 'మీ సొంత మాటల్లో చెప్పండి',
  veStart: 'ఈ భాగాన్ని రికార్డ్ చేయండి',
  veReRecord: 'మళ్ళీ రికార్డ్ చేయండి',
  vePrev: '‹ మునుపటి',
  veNext: 'తర్వాత ›',
  veRecording: 'ఇప్పుడు మాట్లాడండి — మాట్లాడుతూ ఉండండి',
  veSecondsLeft: '{s} సెకన్లు మిగిలాయి',
  veDoneMark: '✓ రికార్డ్ అయింది',
  veProgress: '{total} లో {n} రికార్డ్ అయ్యాయి',
  veSave: 'నా గొంతును సేవ్ చేయండి',
  veUploading: 'అప్‌లోడ్ అవుతోంది…',
